...
type MemoryPool struct {
	...
	Type      PoolType `protobuf:"varint,1,opt,name=type,proto3,enum=stackinsights.v3.PoolType" json:"type,omitempty"`
	Init      int64    `protobuf:"varint,2,opt,name=init,proto3" json:"init,omitempty"`
	Max       int64    `protobuf:"varint,3,opt,name=max,proto3" json:"max,omitempty"`
	Used      int64    `protobuf:"varint,4,opt,name=used,proto3" json:"used,omitempty"`
	Committed int64    `protobuf:"varint,5,opt,name=committed,proto3" json:"committed,omitempty"`
...
type GC struct {
	...
	Phase GCPhase `protobuf:"varint,1,opt,name=phase,proto3,enum=stackinsights.v3.GCPhase" json:"phase,omitempty"`
...
var file_language_agent_JVMMetric_proto_goTypes = []interface{}{
	(PoolType)(0),               // 0: stackinsights.v3.PoolType
	(GCPhase)(0),                // 1: stackinsights.v3.GCPhase
	(*JVMMetricCollection)(nil), // 2: stackinsights.v3.JVMMetricCollection
	(*JVMMetric)(nil),           // 3: stackinsights.v3.JVMMetric
	(*Memory)(nil),              // 4: stackinsights.v3.Memory
	(*MemoryPool)(nil),          // 5: stackinsights.v3.MemoryPool
	(*GC)(nil),                  // 6: stackinsights.v3.GC
	(*Thread)(nil),              // 7: stackinsights.v3.Thread
	(*Class)(nil),               // 8: stackinsights.v3.Class
	(*v3.CPU)(nil),              // 9: stackinsights.v3.CPU
	(*v3.Commands)(nil),         // 10: stackinsights.v3.Commands
}
var file_language_agent_JVMMetric_proto_depIdxs = []int32{
	3,  // 0: stackinsights.v3.JVMMetricCollection.metrics:type_name -> stackinsights.v3.JVMMetric
	9,  // 1: stackinsights.v3.JVMMetric.cpu:type_name -> stackinsights.v3.CPU
	4,  // 2: stackinsights.v3.JVMMetric.memory:type_name -> stackinsights.v3.Memory
	5,  // 3: stackinsights.v3.JVMMetric.memoryPool:type_name -> stackinsights.v3.MemoryPool
	6,  // 4: stackinsights.v3.JVMMetric.gc:type_name -> stackinsights.v3.GC
	7,  // 5: stackinsights.v3.JVMMetric.thread:type_name -> stackinsights.v3.Thread
	8,  // 6: stackinsights.v3.JVMMetric.clazz:type_name -> stackinsights.v3.Class
	0,  // 7: stackinsights.v3.MemoryPool.type:type_name -> stackinsights.v3.PoolType
	1,  // 8: stackinsights.v3.GC.phase:type_name -> stackinsights.v3.GCPhase
	2,  // 9: stackinsights.v3.JVMMetricReportService.collect:input_type -> stackinsights.v3.JVMMetricCollection
	10, // 10: stackinsights.v3.JVMMetricReportService.collect:output_type -> stackinsights.v3.Commands
