...
var file_language_agent_CLRMetric_proto_goTypes = []interface{}{
	(*CLRMetricCollection)(nil), // 0: stackinsights.v3.CLRMetricCollection
	(*CLRMetric)(nil),           // 1: stackinsights.v3.CLRMetric
	(*ClrGC)(nil),               // 2: stackinsights.v3.ClrGC
	(*ClrThread)(nil),           // 3: stackinsights.v3.ClrThread
	(*v3.CPU)(nil),              // 4: stackinsights.v3.CPU
	(*v3.Commands)(nil),         // 5: stackinsights.v3.Commands
}
var file_language_agent_CLRMetric_proto_depIdxs = []int32{
	1, // 0: stackinsights.v3.CLRMetricCollection.metrics:type_name -> stackinsights.v3.CLRMetric
	4, // 1: stackinsights.v3.CLRMetric.cpu:type_name -> stackinsights.v3.CPU
	2, // 2: stackinsights.v3.CLRMetric.gc:type_name -> stackinsights.v3.ClrGC
	3, // 3: stackinsights.v3.CLRMetric.thread:type_name -> stackinsights.v3.ClrThread
	0, // 4: stackinsights.v3.CLRMetricReportService.collect:input_type -> stackinsights.v3.CLRMetricCollection
	5, // 5: stackinsights.v3.CLRMetricReportService.collect:output_type -> stackinsights.v3.Commands
