...
func (c *meterReportServiceClient) Collect(ctx context.Context, opts ...grpc.CallOption) (MeterReportService_CollectClient, error) {
	stream, err := c.cc.NewStream(ctx, &MeterReportService_ServiceDesc.Streams[0], "/stackinsights.v3.MeterReportService/collect", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *meterReportServiceClient) CollectBatch(ctx context.Context, opts ...grpc.CallOption) (MeterReportService_CollectBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &MeterReportService_ServiceDesc.Streams[1], "/stackinsights.v3.MeterReportService/collectBatch", opts...)
	if err != nil {
		return nil, err
	}
...
var MeterReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "stackinsights.v3.MeterReportService",
