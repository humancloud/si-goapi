...
import (
	...
	reflect "reflect"
	v3 "demo.stackinsights.ai/repo/goapi/collect/common/v3"
	sync "sync"
)
...
type SegmentReference struct {
	...
	RefType RefType `protobuf:"varint,1,opt,name=refType,proto3,enum=stackinsights.v3.RefType" json:"refType,omitempty"`
	// A string id represents the whole trace.
	...
	// This plays the important role in the StackInsights STAM(Streaming Topology Analysis Method)
...
type SpanObject struct {
	...
	// Read https://github.com/apache/stackinsights/blob/master/docs/en/setup/backend/endpoint-grouping-rules.md
	...
	// This is required when spanType = Exit, as it is a part of the StackInsights STAM(Streaming Topology Analysis Method).
	// For more details, read https://wu-sheng.github.io/STAM/
	Peer string `protobuf:"bytes,7,opt,name=peer,proto3" json:"peer,omitempty"`
	// Span type represents the role in the RPC context.
	SpanType SpanType `protobuf:"varint,8,opt,name=spanType,proto3,enum=stackinsights.v3.SpanType" json:"spanType,omitempty"`
	// Span layer represent the component tech stack, related to the network tech.
	SpanLayer SpanLayer `protobuf:"varint,9,opt,name=spanLayer,proto3,enum=stackinsights.v3.SpanLayer" json:"spanLayer,omitempty"`
	// Component id is a predefinited number id in the StackInsights.
	// It represents the framework, tech stack used by this tracked span, such as Spring.
	// All IDs are defined in the https://github.com/apache/stackinsights/blob/master/oap-server/server-bootstrap/src/main/resources/component-libraries.yml
	// Send a pull request if you want to add languages, components or mapping defintions,
	// all public components could be accepted.
	// Follow this doc for more details, https://github.com/apache/stackinsights/blob/master/docs/en/guides/Component-library-settings.md
	...
	// https://github.com/apache/stackinsights/blob/master/docs/en/guides/Java-Plugin-Development-Guide.md#special-span-tags
...
type SpanAttachedEvent struct {
	...
	// Notice, most unit of timestamp in StackInsights is milliseconds, but NANO-SECOND is required here.
	...
	// https://stackinsights.apache.org/docs/main/next/en/protocols/stackinsights-cross-process-propagation-headers-protocol-v3/#standard-header-item
...
type SpanAttachedEvent_SpanReference struct {
	...
	Type SpanAttachedEvent_SpanReferenceType `protobuf:"varint,1,opt,name=type,proto3,enum=stackinsights.v3.SpanAttachedEvent_SpanReferenceType" json:"type,omitempty"`
...
var file_language_agent_Tracing_proto_goTypes = []interface{}{
	(SpanType)(0),                            // 0: stackinsights.v3.SpanType
	(RefType)(0),                             // 1: stackinsights.v3.RefType
	(SpanLayer)(0),                           // 2: stackinsights.v3.SpanLayer
	(SpanAttachedEvent_SpanReferenceType)(0), // 3: stackinsights.v3.SpanAttachedEvent.SpanReferenceType
	(*SegmentObject)(nil),                    // 4: stackinsights.v3.SegmentObject
	(*SegmentReference)(nil),                 // 5: stackinsights.v3.SegmentReference
	(*SpanObject)(nil),                       // 6: stackinsights.v3.SpanObject
	(*Log)(nil),                              // 7: stackinsights.v3.Log
	(*ID)(nil),                               // 8: stackinsights.v3.ID
	(*SegmentCollection)(nil),                // 9: stackinsights.v3.SegmentCollection
	(*SpanAttachedEvent)(nil),                // 10: stackinsights.v3.SpanAttachedEvent
	(*SpanAttachedEvent_SpanReference)(nil),  // 11: stackinsights.v3.SpanAttachedEvent.SpanReference
	(*v3.KeyStringValuePair)(nil),            // 12: stackinsights.v3.KeyStringValuePair
	(*v3.Instant)(nil),                       // 13: stackinsights.v3.Instant
	(*v3.KeyIntValuePair)(nil),               // 14: stackinsights.v3.KeyIntValuePair
	(*v3.Commands)(nil),                      // 15: stackinsights.v3.Commands
}
var file_language_agent_Tracing_proto_depIdxs = []int32{
	6,  // 0: stackinsights.v3.SegmentObject.spans:type_name -> stackinsights.v3.SpanObject
	1,  // 1: stackinsights.v3.SegmentReference.refType:type_name -> stackinsights.v3.RefType
	5,  // 2: stackinsights.v3.SpanObject.refs:type_name -> stackinsights.v3.SegmentReference
	0,  // 3: stackinsights.v3.SpanObject.spanType:type_name -> stackinsights.v3.SpanType
	2,  // 4: stackinsights.v3.SpanObject.spanLayer:type_name -> stackinsights.v3.SpanLayer
	12, // 5: stackinsights.v3.SpanObject.tags:type_name -> stackinsights.v3.KeyStringValuePair
	7,  // 6: stackinsights.v3.SpanObject.logs:type_name -> stackinsights.v3.Log
	12, // 7: stackinsights.v3.Log.data:type_name -> stackinsights.v3.KeyStringValuePair
	4,  // 8: stackinsights.v3.SegmentCollection.segments:type_name -> stackinsights.v3.SegmentObject
	13, // 9: stackinsights.v3.SpanAttachedEvent.startTime:type_name -> stackinsights.v3.Instant
	13, // 10: stackinsights.v3.SpanAttachedEvent.endTime:type_name -> stackinsights.v3.Instant
	12, // 11: stackinsights.v3.SpanAttachedEvent.tags:type_name -> stackinsights.v3.KeyStringValuePair
	14, // 12: stackinsights.v3.SpanAttachedEvent.summary:type_name -> stackinsights.v3.KeyIntValuePair
	11, // 13: stackinsights.v3.SpanAttachedEvent.traceContext:type_name -> stackinsights.v3.SpanAttachedEvent.SpanReference
	3,  // 14: stackinsights.v3.SpanAttachedEvent.SpanReference.type:type_name -> stackinsights.v3.SpanAttachedEvent.SpanReferenceType
	4,  // 15: stackinsights.v3.TraceSegmentReportService.collect:input_type -> stackinsights.v3.SegmentObject
	9,  // 16: stackinsights.v3.TraceSegmentReportService.collectInSync:input_type -> stackinsights.v3.SegmentCollection
	10, // 17: stackinsights.v3.SpanAttachedEventReportService.collect:input_type -> stackinsights.v3.SpanAttachedEvent
	15, // 18: stackinsights.v3.TraceSegmentReportService.collect:output_type -> stackinsights.v3.Commands
	15, // 19: stackinsights.v3.TraceSegmentReportService.collectInSync:output_type -> stackinsights.v3.Commands
	15, // 20: stackinsights.v3.SpanAttachedEventReportService.collect:output_type -> stackinsights.v3.Commands
