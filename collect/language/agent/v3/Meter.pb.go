...
var file_language_agent_Meter_proto_goTypes = []interface{}{
	(*Label)(nil),               // 0: stackinsights.v3.Label
	(*MeterBucketValue)(nil),    // 1: stackinsights.v3.MeterBucketValue
	(*MeterSingleValue)(nil),    // 2: stackinsights.v3.MeterSingleValue
	(*MeterHistogram)(nil),      // 3: stackinsights.v3.MeterHistogram
	(*MeterData)(nil),           // 4: stackinsights.v3.MeterData
	(*MeterDataCollection)(nil), // 5: stackinsights.v3.MeterDataCollection
	(*v3.Commands)(nil),         // 6: stackinsights.v3.Commands
}
var file_language_agent_Meter_proto_depIdxs = []int32{
	0, // 0: stackinsights.v3.MeterSingleValue.labels:type_name -> stackinsights.v3.Label
	0, // 1: stackinsights.v3.MeterHistogram.labels:type_name -> stackinsights.v3.Label
	1, // 2: stackinsights.v3.MeterHistogram.values:type_name -> stackinsights.v3.MeterBucketValue
	2, // 3: stackinsights.v3.MeterData.singleValue:type_name -> stackinsights.v3.MeterSingleValue
	3, // 4: stackinsights.v3.MeterData.histogram:type_name -> stackinsights.v3.MeterHistogram
	4, // 5: stackinsights.v3.MeterDataCollection.meterData:type_name -> stackinsights.v3.MeterData
	4, // 6: stackinsights.v3.MeterReportService.collect:input_type -> stackinsights.v3.MeterData
	5, // 7: stackinsights.v3.MeterReportService.collectBatch:input_type -> stackinsights.v3.MeterDataCollection
	6, // 8: stackinsights.v3.MeterReportService.collect:output_type -> stackinsights.v3.Commands
	6, // 9: stackinsights.v3.MeterReportService.collectBatch:output_type -> stackinsights.v3.Commands
