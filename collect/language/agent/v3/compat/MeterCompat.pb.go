...
var file_language_agent_MeterCompat_proto_goTypes = []interface{}{
	(*v3.MeterData)(nil), // 0: stackinsights.v3.MeterData
	(*v31.Commands)(nil), // 1: stackinsights.v3.Commands
}
var file_language_agent_MeterCompat_proto_depIdxs = []int32{
	0, // 0: MeterReportService.collect:input_type -> stackinsights.v3.MeterData
	1, // 1: MeterReportService.collect:output_type -> stackinsights.v3.Commands
