...
type BrowserErrorLog struct {
	...
	Category ErrorCategory `protobuf:"varint,6,opt,name=category,proto3,enum=stackinsights.v3.ErrorCategory" json:"category,omitempty"`
...
var file_browser_BrowserPerf_proto_goTypes = []interface{}{
	(ErrorCategory)(0),      // 0: stackinsights.v3.ErrorCategory
	(*BrowserPerfData)(nil), // 1: stackinsights.v3.BrowserPerfData
	(*BrowserErrorLog)(nil), // 2: stackinsights.v3.BrowserErrorLog
	(*v3.Commands)(nil),     // 3: stackinsights.v3.Commands
}
var file_browser_BrowserPerf_proto_depIdxs = []int32{
	0, // 0: stackinsights.v3.BrowserErrorLog.category:type_name -> stackinsights.v3.ErrorCategory
	1, // 1: stackinsights.v3.BrowserPerfService.collectPerfData:input_type -> stackinsights.v3.BrowserPerfData
	2, // 2: stackinsights.v3.BrowserPerfService.collectErrorLogs:input_type -> stackinsights.v3.BrowserErrorLog
	3, // 3: stackinsights.v3.BrowserPerfService.collectPerfData:output_type -> stackinsights.v3.Commands
	3, // 4: stackinsights.v3.BrowserPerfService.collectErrorLogs:output_type -> stackinsights.v3.Commands
