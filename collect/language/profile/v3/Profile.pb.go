...
var file_profile_Profile_proto_goTypes = []interface{}{
	(*ProfileTaskCommandQuery)(nil), // 0: stackinsights.v3.ProfileTaskCommandQuery
	(*ThreadSnapshot)(nil),          // 1: stackinsights.v3.ThreadSnapshot
	(*ThreadStack)(nil),             // 2: stackinsights.v3.ThreadStack
	(*ProfileTaskFinishReport)(nil), // 3: stackinsights.v3.ProfileTaskFinishReport
	(*v3.Commands)(nil),             // 4: stackinsights.v3.Commands
}
var file_profile_Profile_proto_depIdxs = []int32{
	2, // 0: stackinsights.v3.ThreadSnapshot.stack:type_name -> stackinsights.v3.ThreadStack
	0, // 1: stackinsights.v3.ProfileTask.getProfileTaskCommands:input_type -> stackinsights.v3.ProfileTaskCommandQuery
	1, // 2: stackinsights.v3.ProfileTask.collectSnapshot:input_type -> stackinsights.v3.ThreadSnapshot
	3, // 3: stackinsights.v3.ProfileTask.reportTaskFinish:input_type -> stackinsights.v3.ProfileTaskFinishReport
	4, // 4: stackinsights.v3.ProfileTask.getProfileTaskCommands:output_type -> stackinsights.v3.Commands
	4, // 5: stackinsights.v3.ProfileTask.collectSnapshot:output_type -> stackinsights.v3.Commands
	4, // 6: stackinsights.v3.ProfileTask.reportTaskFinish:output_type -> stackinsights.v3.Commands
