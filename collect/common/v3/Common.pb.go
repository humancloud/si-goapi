...
var file_common_Common_proto_goTypes = []interface{}{
	(DetectPoint)(0),           // 0: stackinsights.v3.DetectPoint
	(*KeyStringValuePair)(nil), // 1: stackinsights.v3.KeyStringValuePair
	(*KeyIntValuePair)(nil),    // 2: stackinsights.v3.KeyIntValuePair
	(*CPU)(nil),                // 3: stackinsights.v3.CPU
	(*Instant)(nil),            // 4: stackinsights.v3.Instant
}
