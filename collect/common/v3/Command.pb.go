...
var file_common_Command_proto_goTypes = []interface{}{
	(*Command)(nil),            // 0: stackinsights.v3.Command
	(*Commands)(nil),           // 1: stackinsights.v3.Commands
	(*KeyStringValuePair)(nil), // 2: stackinsights.v3.KeyStringValuePair
}
var file_common_Command_proto_depIdxs = []int32{
	2, // 0: stackinsights.v3.Command.args:type_name -> stackinsights.v3.KeyStringValuePair
	0, // 1: stackinsights.v3.Commands.commands:type_name -> stackinsights.v3.Command
