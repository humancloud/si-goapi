...
var file_management_Management_proto_goTypes = []interface{}{
	(*InstanceProperties)(nil),    // 0: stackinsights.v3.InstanceProperties
	(*InstancePingPkg)(nil),       // 1: stackinsights.v3.InstancePingPkg
	(*v3.KeyStringValuePair)(nil), // 2: stackinsights.v3.KeyStringValuePair
	(*v3.Commands)(nil),           // 3: stackinsights.v3.Commands
}
var file_management_Management_proto_depIdxs = []int32{
	2, // 0: stackinsights.v3.InstanceProperties.properties:type_name -> stackinsights.v3.KeyStringValuePair
	0, // 1: stackinsights.v3.ManagementService.reportInstanceProperties:input_type -> stackinsights.v3.InstanceProperties
	1, // 2: stackinsights.v3.ManagementService.keepAlive:input_type -> stackinsights.v3.InstancePingPkg
	3, // 3: stackinsights.v3.ManagementService.reportInstanceProperties:output_type -> stackinsights.v3.Commands
	3, // 4: stackinsights.v3.ManagementService.keepAlive:output_type -> stackinsights.v3.Commands
