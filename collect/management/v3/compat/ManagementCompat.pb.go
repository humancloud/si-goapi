...
import (
	...
	v3 "demo.stackinsights.ai/repo/goapi/collect/management/v3"
)
...
var file_management_ManagementCompat_proto_goTypes = []interface{}{
	(*v3.InstanceProperties)(nil), // 0: stackinsights.v3.InstanceProperties
	(*v3.InstancePingPkg)(nil),    // 1: stackinsights.v3.InstancePingPkg
	(*v31.Commands)(nil),          // 2: stackinsights.v3.Commands
}
var file_management_ManagementCompat_proto_depIdxs = []int32{
	0, // 0: ManagementService.reportInstanceProperties:input_type -> stackinsights.v3.InstanceProperties
	1, // 1: ManagementService.keepAlive:input_type -> stackinsights.v3.InstancePingPkg
	2, // 2: ManagementService.reportInstanceProperties:output_type -> stackinsights.v3.Commands
	2, // 3: ManagementService.keepAlive:output_type -> stackinsights.v3.Commands
