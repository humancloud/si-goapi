...
var file_ebpf_profiling_Process_proto_goTypes = []interface{}{
	(*EBPFProcessReportList)(nil),           // 0: stackinsights.v3.EBPFProcessReportList
	(*EBPFProcessProperties)(nil),           // 1: stackinsights.v3.EBPFProcessProperties
	(*EBPFHostProcessMetadata)(nil),         // 2: stackinsights.v3.EBPFHostProcessMetadata
	(*EBPFProcessEntityMetadata)(nil),       // 3: stackinsights.v3.EBPFProcessEntityMetadata
	(*EBPFKubernetesProcessMetadata)(nil),   // 4: stackinsights.v3.EBPFKubernetesProcessMetadata
	(*EBPFReportProcessDownstream)(nil),     // 5: stackinsights.v3.EBPFReportProcessDownstream
	(*EBPFProcessDownstream)(nil),           // 6: stackinsights.v3.EBPFProcessDownstream
	(*EBPFHostProcessDownstream)(nil),       // 7: stackinsights.v3.EBPFHostProcessDownstream
	(*EBPFKubernetesProcessDownstream)(nil), // 8: stackinsights.v3.EBPFKubernetesProcessDownstream
	(*EBPFProcessPingPkgList)(nil),          // 9: stackinsights.v3.EBPFProcessPingPkgList
	(*EBPFProcessPingPkg)(nil),              // 10: stackinsights.v3.EBPFProcessPingPkg
	(*v3.KeyStringValuePair)(nil),           // 11: stackinsights.v3.KeyStringValuePair
	(*v3.Commands)(nil),                     // 12: stackinsights.v3.Commands
}
var file_ebpf_profiling_Process_proto_depIdxs = []int32{
	1,  // 0: stackinsights.v3.EBPFProcessReportList.processes:type_name -> stackinsights.v3.EBPFProcessProperties
	2,  // 1: stackinsights.v3.EBPFProcessProperties.hostProcess:type_name -> stackinsights.v3.EBPFHostProcessMetadata
	4,  // 2: stackinsights.v3.EBPFProcessProperties.k8sProcess:type_name -> stackinsights.v3.EBPFKubernetesProcessMetadata
	3,  // 3: stackinsights.v3.EBPFHostProcessMetadata.entity:type_name -> stackinsights.v3.EBPFProcessEntityMetadata
	11, // 4: stackinsights.v3.EBPFHostProcessMetadata.properties:type_name -> stackinsights.v3.KeyStringValuePair
	3,  // 5: stackinsights.v3.EBPFKubernetesProcessMetadata.entity:type_name -> stackinsights.v3.EBPFProcessEntityMetadata
	11, // 6: stackinsights.v3.EBPFKubernetesProcessMetadata.properties:type_name -> stackinsights.v3.KeyStringValuePair
	6,  // 7: stackinsights.v3.EBPFReportProcessDownstream.processes:type_name -> stackinsights.v3.EBPFProcessDownstream
	7,  // 8: stackinsights.v3.EBPFProcessDownstream.hostProcess:type_name -> stackinsights.v3.EBPFHostProcessDownstream
	8,  // 9: stackinsights.v3.EBPFProcessDownstream.k8sProcess:type_name -> stackinsights.v3.EBPFKubernetesProcessDownstream
	3,  // 10: stackinsights.v3.EBPFHostProcessDownstream.entityMetadata:type_name -> stackinsights.v3.EBPFProcessEntityMetadata
	3,  // 11: stackinsights.v3.EBPFKubernetesProcessDownstream.entityMetadata:type_name -> stackinsights.v3.EBPFProcessEntityMetadata
	10, // 12: stackinsights.v3.EBPFProcessPingPkgList.processes:type_name -> stackinsights.v3.EBPFProcessPingPkg
	3,  // 13: stackinsights.v3.EBPFProcessPingPkg.entityMetadata:type_name -> stackinsights.v3.EBPFProcessEntityMetadata
	11, // 14: stackinsights.v3.EBPFProcessPingPkg.properties:type_name -> stackinsights.v3.KeyStringValuePair
	0,  // 15: stackinsights.v3.EBPFProcessService.reportProcesses:input_type -> stackinsights.v3.EBPFProcessReportList
	9,  // 16: stackinsights.v3.EBPFProcessService.keepAlive:input_type -> stackinsights.v3.EBPFProcessPingPkgList
	5,  // 17: stackinsights.v3.EBPFProcessService.reportProcesses:output_type -> stackinsights.v3.EBPFReportProcessDownstream
	12, // 18: stackinsights.v3.EBPFProcessService.keepAlive:output_type -> stackinsights.v3.Commands
