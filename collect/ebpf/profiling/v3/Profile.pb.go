...
type EBPFProfilingStackMetadata struct {
	...
	// stack type
	StackType EBPFProfilingStackType `protobuf:"varint,1,opt,name=stackType,proto3,enum=stackinsights.v3.EBPFProfilingStackType" json:"stackType,omitempty"`
...
var file_ebpf_profiling_Profile_proto_goTypes = []interface{}{
	(EBPFProfilingStackType)(0),        // 0: stackinsights.v3.EBPFProfilingStackType
	(*EBPFProfilingTaskQuery)(nil),     // 1: stackinsights.v3.EBPFProfilingTaskQuery
	(*EBPFProfilingData)(nil),          // 2: stackinsights.v3.EBPFProfilingData
	(*EBPFProfilingTaskMetadata)(nil),  // 3: stackinsights.v3.EBPFProfilingTaskMetadata
	(*EBPFProfilingStackMetadata)(nil), // 4: stackinsights.v3.EBPFProfilingStackMetadata
	(*EBPFOnCPUProfiling)(nil),         // 5: stackinsights.v3.EBPFOnCPUProfiling
	(*EBPFOffCPUProfiling)(nil),        // 6: stackinsights.v3.EBPFOffCPUProfiling
	(*v3.Commands)(nil),                // 7: stackinsights.v3.Commands
}
var file_ebpf_profiling_Profile_proto_depIdxs = []int32{
	3, // 0: stackinsights.v3.EBPFProfilingData.task:type_name -> stackinsights.v3.EBPFProfilingTaskMetadata
	5, // 1: stackinsights.v3.EBPFProfilingData.onCPU:type_name -> stackinsights.v3.EBPFOnCPUProfiling
	6, // 2: stackinsights.v3.EBPFProfilingData.offCPU:type_name -> stackinsights.v3.EBPFOffCPUProfiling
	0, // 3: stackinsights.v3.EBPFProfilingStackMetadata.stackType:type_name -> stackinsights.v3.EBPFProfilingStackType
	4, // 4: stackinsights.v3.EBPFOnCPUProfiling.stacks:type_name -> stackinsights.v3.EBPFProfilingStackMetadata
	4, // 5: stackinsights.v3.EBPFOffCPUProfiling.stacks:type_name -> stackinsights.v3.EBPFProfilingStackMetadata
	1, // 6: stackinsights.v3.EBPFProfilingService.queryTasks:input_type -> stackinsights.v3.EBPFProfilingTaskQuery
	2, // 7: stackinsights.v3.EBPFProfilingService.collectProfilingData:input_type -> stackinsights.v3.EBPFProfilingData
	7, // 8: stackinsights.v3.EBPFProfilingService.queryTasks:output_type -> stackinsights.v3.Commands
	7, // 9: stackinsights.v3.EBPFProfilingService.collectProfilingData:output_type -> stackinsights.v3.Commands
