...
type ContinuousProfilingCause struct {
	...
	Type ContinuousProfilingTriggeredMonitorType `protobuf:"varint,1,opt,name=type,proto3,enum=stackinsights.v3.ContinuousProfilingTriggeredMonitorType" json:"type,omitempty"`
...
var file_ebpf_profiling_Continuous_proto_goTypes = []interface{}{
	(ContinuousProfilingTriggeredMonitorType)(0),  // 0: stackinsights.v3.ContinuousProfilingTriggeredMonitorType
	(*ContinuousProfilingPolicyQuery)(nil),        // 1: stackinsights.v3.ContinuousProfilingPolicyQuery
	(*ContinuousProfilingServicePolicyQuery)(nil), // 2: stackinsights.v3.ContinuousProfilingServicePolicyQuery
	(*ContinuousProfilingReport)(nil),             // 3: stackinsights.v3.ContinuousProfilingReport
	(*ContinuousProfilingCause)(nil),              // 4: stackinsights.v3.ContinuousProfilingCause
	(*ContinuousProfilingSingleValueCause)(nil),   // 5: stackinsights.v3.ContinuousProfilingSingleValueCause
	(*ContinuousProfilingURICause)(nil),           // 6: stackinsights.v3.ContinuousProfilingURICause
	(*ContinuousOnCPUProfilingTask)(nil),          // 7: stackinsights.v3.ContinuousOnCPUProfilingTask
	(*ContinuousOffCPUProfilingTask)(nil),         // 8: stackinsights.v3.ContinuousOffCPUProfilingTask
	(*ContinuousNetworkProfilingTask)(nil),        // 9: stackinsights.v3.ContinuousNetworkProfilingTask
	(*v3.Commands)(nil),                           // 10: stackinsights.v3.Commands
}
var file_ebpf_profiling_Continuous_proto_depIdxs = []int32{
	2,  // 0: stackinsights.v3.ContinuousProfilingPolicyQuery.policies:type_name -> stackinsights.v3.ContinuousProfilingServicePolicyQuery
	4,  // 1: stackinsights.v3.ContinuousProfilingReport.causes:type_name -> stackinsights.v3.ContinuousProfilingCause
	7,  // 2: stackinsights.v3.ContinuousProfilingReport.onCPU:type_name -> stackinsights.v3.ContinuousOnCPUProfilingTask
	8,  // 3: stackinsights.v3.ContinuousProfilingReport.offCPU:type_name -> stackinsights.v3.ContinuousOffCPUProfilingTask
	9,  // 4: stackinsights.v3.ContinuousProfilingReport.network:type_name -> stackinsights.v3.ContinuousNetworkProfilingTask
	0,  // 5: stackinsights.v3.ContinuousProfilingCause.type:type_name -> stackinsights.v3.ContinuousProfilingTriggeredMonitorType
	5,  // 6: stackinsights.v3.ContinuousProfilingCause.singleValue:type_name -> stackinsights.v3.ContinuousProfilingSingleValueCause
	6,  // 7: stackinsights.v3.ContinuousProfilingCause.uri:type_name -> stackinsights.v3.ContinuousProfilingURICause
	1,  // 8: stackinsights.v3.ContinuousProfilingService.queryPolicies:input_type -> stackinsights.v3.ContinuousProfilingPolicyQuery
	3,  // 9: stackinsights.v3.ContinuousProfilingService.reportProfilingTask:input_type -> stackinsights.v3.ContinuousProfilingReport
	10, // 10: stackinsights.v3.ContinuousProfilingService.queryPolicies:output_type -> stackinsights.v3.Commands
	10, // 11: stackinsights.v3.ContinuousProfilingService.reportProfilingTask:output_type -> stackinsights.v3.Commands
