...
var file_logging_Logging_proto_goTypes = []interface{}{
	(*LogData)(nil),               // 0: stackinsights.v3.LogData
	(*LogDataBody)(nil),           // 1: stackinsights.v3.LogDataBody
	(*TextLog)(nil),               // 2: stackinsights.v3.TextLog
	(*JSONLog)(nil),               // 3: stackinsights.v3.JSONLog
	(*YAMLLog)(nil),               // 4: stackinsights.v3.YAMLLog
	(*TraceContext)(nil),          // 5: stackinsights.v3.TraceContext
	(*LogTags)(nil),               // 6: stackinsights.v3.LogTags
	(*v3.KeyStringValuePair)(nil), // 7: stackinsights.v3.KeyStringValuePair
	(*v3.Commands)(nil),           // 8: stackinsights.v3.Commands
}
var file_logging_Logging_proto_depIdxs = []int32{
	1, // 0: stackinsights.v3.LogData.body:type_name -> stackinsights.v3.LogDataBody
	5, // 1: stackinsights.v3.LogData.traceContext:type_name -> stackinsights.v3.TraceContext
	6, // 2: stackinsights.v3.LogData.tags:type_name -> stackinsights.v3.LogTags
	2, // 3: stackinsights.v3.LogDataBody.text:type_name -> stackinsights.v3.TextLog
	3, // 4: stackinsights.v3.LogDataBody.json:type_name -> stackinsights.v3.JSONLog
	4, // 5: stackinsights.v3.LogDataBody.yaml:type_name -> stackinsights.v3.YAMLLog
	7, // 6: stackinsights.v3.LogTags.data:type_name -> stackinsights.v3.KeyStringValuePair
	0, // 7: stackinsights.v3.LogReportService.collect:input_type -> stackinsights.v3.LogData
	8, // 8: stackinsights.v3.LogReportService.collect:output_type -> stackinsights.v3.Commands
