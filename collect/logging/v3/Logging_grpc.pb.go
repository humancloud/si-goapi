...
func (c *logReportServiceClient) Collect(ctx context.Context, opts ...grpc.CallOption) (LogReportService_CollectClient, error) {
	stream, err := c.cc.NewStream(ctx, &LogReportService_ServiceDesc.Streams[0], "/stackinsights.v3.LogReportService/collect", opts...)
	if err != nil {
		return nil, err
	}
...
var LogReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "stackinsights.v3.LogReportService",
