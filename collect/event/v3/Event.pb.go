...
type Event struct {
	...
	Type Type `protobuf:"varint,4,opt,name=type,proto3,enum=stackinsights.v3.Type" json:"type,omitempty"`
...
var file_event_Event_proto_goTypes = []interface{}{
	(Type)(0),           // 0: stackinsights.v3.Type
	(*Event)(nil),       // 1: stackinsights.v3.Event
	(*Source)(nil),      // 2: stackinsights.v3.Source
	nil,                 // 3: stackinsights.v3.Event.ParametersEntry
	(*v3.Commands)(nil), // 4: stackinsights.v3.Commands
}
var file_event_Event_proto_depIdxs = []int32{
	2, // 0: stackinsights.v3.Event.source:type_name -> stackinsights.v3.Source
	0, // 1: stackinsights.v3.Event.type:type_name -> stackinsights.v3.Type
	3, // 2: stackinsights.v3.Event.parameters:type_name -> stackinsights.v3.Event.ParametersEntry
	1, // 3: stackinsights.v3.EventService.collect:input_type -> stackinsights.v3.Event
	4, // 4: stackinsights.v3.EventService.collect:output_type -> stackinsights.v3.Commands
