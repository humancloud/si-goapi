...
var file_language_agent_ConfigurationDiscoveryService_proto_goTypes = []interface{}{
	(*ConfigurationSyncRequest)(nil), // 0: stackinsights.v3.ConfigurationSyncRequest
	(*v3.Commands)(nil),              // 1: stackinsights.v3.Commands
}
var file_language_agent_ConfigurationDiscoveryService_proto_depIdxs = []int32{
	0, // 0: stackinsights.v3.ConfigurationDiscoveryService.fetchConfigurations:input_type -> stackinsights.v3.ConfigurationSyncRequest
	1, // 1: stackinsights.v3.ConfigurationDiscoveryService.fetchConfigurations:output_type -> stackinsights.v3.Commands
