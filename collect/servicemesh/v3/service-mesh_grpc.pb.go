...
func (c *serviceMeshMetricServiceClient) Collect(ctx context.Context, opts ...grpc.CallOption) (ServiceMeshMetricService_CollectClient, error) {
	stream, err := c.cc.NewStream(ctx, &ServiceMeshMetricService_ServiceDesc.Streams[0], "/stackinsights.v3.ServiceMeshMetricService/collect", opts...)
	if err != nil {
		return nil, err
	}
...
var ServiceMeshMetricService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "stackinsights.v3.ServiceMeshMetricService",
