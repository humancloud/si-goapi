...
type HTTPServiceMeshMetric struct {
	...
	Protocol    Protocol       `protobuf:"varint,11,opt,name=protocol,proto3,enum=stackinsights.v3.Protocol" json:"protocol,omitempty"`
	DetectPoint v3.DetectPoint `protobuf:"varint,12,opt,name=detectPoint,proto3,enum=stackinsights.v3.DetectPoint" json:"detectPoint,omitempty"`
	// NONE, mTLS, or TLS
...
type TCPServiceMeshMetric struct {
	...
	DestServiceName       string         `protobuf:"bytes,5,opt,name=destServiceName,proto3" json:"destServiceName,omitempty"`
	DestServiceInstance   string         `protobuf:"bytes,6,opt,name=destServiceInstance,proto3" json:"destServiceInstance,omitempty"`
	DetectPoint           v3.DetectPoint `protobuf:"varint,7,opt,name=detectPoint,proto3,enum=stackinsights.v3.DetectPoint" json:"detectPoint,omitempty"`
	// NONE, mTLS, or TLS
...
var file_service_mesh_probe_service_mesh_proto_goTypes = []interface{}{
	(Protocol)(0),                  // 0: stackinsights.v3.Protocol
	(*ServiceMeshMetrics)(nil),     // 1: stackinsights.v3.ServiceMeshMetrics
	(*HTTPServiceMeshMetric)(nil),  // 2: stackinsights.v3.HTTPServiceMeshMetric
	(*HTTPServiceMeshMetrics)(nil), // 3: stackinsights.v3.HTTPServiceMeshMetrics
	(*TCPServiceMeshMetric)(nil),   // 4: stackinsights.v3.TCPServiceMeshMetric
	(*TCPServiceMeshMetrics)(nil),  // 5: stackinsights.v3.TCPServiceMeshMetrics
	(*MeshProbeDownstream)(nil),    // 6: stackinsights.v3.MeshProbeDownstream
	(v3.DetectPoint)(0),            // 7: stackinsights.v3.DetectPoint
	(*v3.KeyStringValuePair)(nil),  // 8: stackinsights.v3.KeyStringValuePair
}
var file_service_mesh_probe_service_mesh_proto_depIdxs = []int32{
	3,  // 0: stackinsights.v3.ServiceMeshMetrics.httpMetrics:type_name -> stackinsights.v3.HTTPServiceMeshMetrics
	5,  // 1: stackinsights.v3.ServiceMeshMetrics.tcpMetrics:type_name -> stackinsights.v3.TCPServiceMeshMetrics
	0,  // 2: stackinsights.v3.HTTPServiceMeshMetric.protocol:type_name -> stackinsights.v3.Protocol
	7,  // 3: stackinsights.v3.HTTPServiceMeshMetric.detectPoint:type_name -> stackinsights.v3.DetectPoint
	8,  // 4: stackinsights.v3.HTTPServiceMeshMetric.sourceInstanceProperties:type_name -> stackinsights.v3.KeyStringValuePair
	8,  // 5: stackinsights.v3.HTTPServiceMeshMetric.destInstanceProperties:type_name -> stackinsights.v3.KeyStringValuePair
	2,  // 6: stackinsights.v3.HTTPServiceMeshMetrics.metrics:type_name -> stackinsights.v3.HTTPServiceMeshMetric
	7,  // 7: stackinsights.v3.TCPServiceMeshMetric.detectPoint:type_name -> stackinsights.v3.DetectPoint
	8,  // 8: stackinsights.v3.TCPServiceMeshMetric.sourceInstanceProperties:type_name -> stackinsights.v3.KeyStringValuePair
	8,  // 9: stackinsights.v3.TCPServiceMeshMetric.destInstanceProperties:type_name -> stackinsights.v3.KeyStringValuePair
	4,  // 10: stackinsights.v3.TCPServiceMeshMetrics.metrics:type_name -> stackinsights.v3.TCPServiceMeshMetric
	1,  // 11: stackinsights.v3.ServiceMeshMetricService.collect:input_type -> stackinsights.v3.ServiceMeshMetrics
	6,  // 12: stackinsights.v3.ServiceMeshMetricService.collect:output_type -> stackinsights.v3.MeshProbeDownstream
